...
response = prompt('Is watermelon not my favorite food?').toLowerCase();
if (response == 'yes' || response == 'y') {
    console.log(incorrect);
} else if (response == 'no' || response == 'n') {
    console.log(correct);
...
response = prompt('Is my favorite color blue?').toLowerCase();
if (response == 'yes' || response == 'y') {
    console.log(incorrect);
} else if (response == 'no' || response == 'n') {
    console.log(correct);
...
response = prompt('Do I enjoy listening to music?').toLowerCase();
if (response == 'yes' || response == 'y') {
    console.log(correct);
} else if (response == 'no' || response == 'n') {
    console.log(incorrect);
...
response = prompt('Is Gundam Unicorn my favorite anime?').toLowerCase();
if (response == 'yes' || response == 'y') {
